...
<form action="" method="post" class="border p-5">
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="mb-4">
                <label for="nom" class="label-control"><h5>Nom</h5></label>
        ...
        <div class="col-sm-6">
            <div class="mb-4">
                <label for="prenom" class="label-control"><h5>Prenom</h5></label>
                <input type="text" name="prenom" id="prenom" class="form-control" value="<?= $prenom; ?>">
            </div>
            <div class="mb-4">
                <label for="email" class="label-control"><h5>Votre adresse email</h5></label>
                <input type="text" name="email" id="email" class="form-control" value="<?= $email; ?>">
            </div>
            <div class="mb-4">
                <label for="civilite" class="form-label"><h5>Civilité</h5></label>
        ...
        <div class="mb-3 mt-4">
        <p class="text-center">Vous avez déjà un compte? <a href="connexion.php" class="text-secondary">Connectez-vous</a></p>
      </div>
    </div>
</form>
